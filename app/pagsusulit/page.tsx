...
export default function PagsusuliPage() {
  ...
  const questions = [
    ...
    },
    {
      ...
      options: [
        { id: 1, imageUrl: "/images/sungaw.jpg" },
        { id: 2, imageUrl: "/images/sirni.jpg" },
        { id: 3, imageUrl: "/images/bareta.jpg" },
        { id: 4, imageUrl: "/images/laad.jpg" },
      ],
      correctAnswer: 3,
    },
    {
      ...
      options: [
        ...
        { id: 2, imageUrl: "/images/tingitingi.jpg" },
        { id: 3, imageUrl: "/images/ningas.jpg" },
    ...
    },
    {
      ...
      options: [
        ...
        { id: 4, imageUrl: "/images/gatong.jpg" },
      ],
      correctAnswer: 2,
    },
    {
      ...
      options: [
        { id: 1, imageUrl: "/images/switer.jpg" },
        { id: 2, imageUrl: "/images/bareta.jpg" },
        { id: 3, imageUrl: "/images/gwantes.jpg" },
        { id: 4, imageUrl: "/images/daga.jpg" },
      ],
      correctAnswer: 3,
    },
    {
    ...
    },
    {
      ...
      options: [
        ...
        { id: 2, imageUrl: "/images/sundang.jpg" },
        { id: 3, imageUrl: "/images/sirni.jpg" },
        { id: 4, imageUrl: "/images/pala.jpg" },
      ],
      correctAnswer: 4,
    },
    {
      ...
      options: [
        { id: 1, imageUrl: "/images/palapa.jpg" },
        { id: 2, imageUrl: "/images/sako.jpg" },
        { id: 3, imageUrl: "/images/pugon.jpg" },
        { id: 4, imageUrl: "/images/albok.jpg" },
      ],
      correctAnswer: 2,
    },
    {
      ...
      options: [
        { id: 1, imageUrl: "images/uring.jpg" },
        { id: 2, imageUrl: "/images/baga.jpg" },
        { id: 3, imageUrl: "/images/kalot.jpg" },
        { id: 4, imageUrl: "/images/gatong.jpg" },
      ],
      correctAnswer: 1,
    },
